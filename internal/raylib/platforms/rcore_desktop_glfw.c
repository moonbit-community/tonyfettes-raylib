...
*/
    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                // NOTE: This keeps initialization alive when monitor discovery fails, but can
                // propagate 0x0 dimensions if requested screen size is zero (windowed-fullscreen).
                // Any future refactor here must preserve non-zero invariants before high-DPI math.
    ...
    else
    {
        ...
        // Without this guard, glfwGetMonitorWorkarea(monitor, ...) would dereference a null monitor handle.
        if (monitor)
        {
            int monitorX = 0;
            int monitorY = 0;
